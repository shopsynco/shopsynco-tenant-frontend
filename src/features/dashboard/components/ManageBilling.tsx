...
import { AddCardModal } from "./payment/AddPaymentMethodModal";

import { EditCardModal, EditUpiModal, EditBankModal } from "./payment/EditPaymentMethod";


type PaymentModalType = "add" | "editCard" | "editBank" | "editUPI" | null;
...
export default function ManageBillingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-[#E8E4F7] shadow-sm p-6 space-y-5">
              <h3 className="text-base font-semibold text-[#6A3CB1]">Payment Method</h3>
              ...
              <div className="flex items-center justify-between bg-[#F9F8FF] border border-[#E9E4FB] rounded-xl p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Expires on Sep 20, 2026</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="px-4 py-1.5 text-sm text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 transition"
                >
                  Edit
                </button>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-[#E8E4F7] bg-white p-6 text-gray-700">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-semibold text-gray-800">Need help with billing?</h4>
              </div>
      ...
      {/* 🧩 Modal Renderer */}
      {activeModal === "add" && <AddCardModal onClose={() => setActiveModal(null)} />}
      {activeModal === "editCard" && <EditCardModal onClose={() => setActiveModal(null)} />}
      {activeModal === "editBank" && <EditBankModal onClose={() => setActiveModal(null)} />}
      {activeModal === "editUPI" && <EditUpiModal onClose={() => setActiveModal(null)} />}
    </div>
  );
}
